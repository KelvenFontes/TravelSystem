    ...
    <div className='flex flex-col '>
      ...
      <div className="hidden lg:grid grid-cols-[2fr,1fr,1fr] gap-2 grid-rows-2 lg:order-2">
        <div className="relative row-span-2">
          <Image src={trip.coverImage} fill style={{ objectFit: "cover" }} alt={trip.name} className='rounded-tl-lg rounded-bl-lg shadow-md' />
        </div>

        <div className="relative h-[200px] w-full">
          <Image src={trip.imagesUrl[0]} fill style={{ objectFit: "cover" }} alt={trip.name} className='shadow-md' />
        </div>

        <div className="relative h-[200px] w-full">
          <Image src={trip.imagesUrl[1]} fill style={{ objectFit: "cover" }} alt={trip.name} className='shadow-md rounded-tr-lg' />
        </div>

        <div className="relative h-[200px] w-full">
          <Image src={trip.imagesUrl[2]} fill style={{ objectFit: "cover" }} alt={trip.name} className='shadow-md' />
        </div>

        <div className="relative h-[200px] w-full">
          <Image src={trip.coverImage} fill style={{ objectFit: "cover" }} alt={trip.name} className='shadow-md rounded-br-lg' />
        </div>
      </div>
